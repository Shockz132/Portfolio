        ...
        <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
            <div>
                ...
                <WorkProcess
                    ...
                    descriptions={[
                        "We started by conducting a survey around several communities which had a community gardens to interview our target audiences by getting the local elderly community gardeners to do our questionnaire. We had a little problem trying to craft a set of questions to ask the gardeners as we ourselves are not gardeners but we educated ourselves on some of the gardening practices and processes and eventually came up with a suitable questionnaire. Following that we collected the data from the questionnaire and identified the key areas to focus on when designing a solution. From there we brainstormed and evaluated our ideas based on certain criterias before finalising our solution. During the evaluation phase when selecting our final idea we had some conflicts of interests which we had to resolve before we finalised our idea. Lastly, we designed the system block diagram for our selected idea in preperation for the development and prototyping phase, however we did face some problems trying to find the different signals that each sensor was sending and receiving but we managed to get past it using the official documentaiton and specifications of the sensors on the mikroe website.",
                        "During the entire Development and Planning stage, I allocated roles to each of my team members to evenly distribute the workload and play to their strengths. We started by using the system block diagram for our selected idea in preperation for the development to first build out the Python code for each beaglebone which each person was in charge of their own beaglebone, we all had our fair share of issues like the inaccuracy of sensors, inconsistency in the performance of the sensors and the many bugs in our code but we managed to overcome these challenges by helping each other out and seeking help from our lecturer when we can't solve it ourselves. Alongside that, I was building out the web server and the database so that we can test the beaglebones which also had its fair share of issues like the server not receiving the data after a certain amount of time, creating the database since I wasn't familiar with SQL at that time but I managed to overcome both of these problems by reading the documentation of the library and standardising the format that we send the data. Following that we brainstormed ideas for the prototype designs by using detailed sketches and following that we finalised the prototype design and started making the 3D models which each of us were responsible for one model each. Finally once we finalised the 3D models we made replicas of the 3D models using recycled materials we could find at NYP's Makerspace.",
                        "Before developing the website, we started by first deciding on the tech stack that we will use to build the website. We decided to use NextJS with React Typescript, due to the wide adoption of React among the web development community as well as NextJS being widely used by big companies like Netflix, Notion, Twitch and many more, making NextJS a useful React framework to know for building modern websites and finally we chose Typescript as the syntax is very similar to Javascript making it easy to learn and its stricter type definitions make it safer by reducing the number of bugs and issues that make it into the final production code, reducing problems caused for both the application and the user. The colour scheme is essential to leaving an impression on the user, hence we decided to spend some time to carefully choose the colour scheme. We then continued to design the layout of all the pages of the website and the user experience. Following that, we spent a considerable amount of time to ensure the user experience was smooth and consistent and that the website was easy to use and understand, including a demo of the website. The main challenge here was familiarising with NextJS, React and Typescript which we were all unfaimliar with but after a little practice and watching some tutorials, we managed to familiarise ourselves with them and manage to finish developing the website.",
                    ]}
                    imgArrays={[
                      [
                ...
                <OutcomeAndResults 
                  contentArray={[
                    "In the end, the project was a success. I as the team leader feel that the work we have put out for this project was incredibly well done, not to say it couldn't have been improved but for the time we and level of effort that we put into Plant Pulse I can safely say this is a piece of work that I am proud of and the team should be too. After we gave a presentation on the project to a panel of judges which was made up of senior lecturers and the module leader, one of the senior lecturers actually proposed that we further take this project up another level and in certain areas possibly even make into a reality by contacting some companies he has connections with. The module leader also selected our project for NYP's Tech Nexus 2025, where we will present to many directors from companies that NYP closely work with to showcase our work to them, and from there possibly have the opportunity to work with them in the future.",
                    "If I were to continue to work on this project in the future, I would definitely sepnd  more time into building the functionalities of the website as this project, given more time would definitely become much better and maybe even commercial ready work to put out there to test and maybe even turn into a business one day. I would also want to put more time into finding better resources for building the prototype like leveraging on the power of 3D printing to build the prototypes which might have cut down the time spent on building it ourselves by a lot which could ahve given us more time to allocate to other areas like building out the functionalities of the website."
                  ]}
                />
                <ProjectShowcase 
