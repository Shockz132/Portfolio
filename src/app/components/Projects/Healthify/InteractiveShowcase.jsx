  ...
  return (
    <div id={id} className={`flex flex-col ${reverse ? 'lg:flex-row-reverse' : 'lg:flex-row'} gap-6 md:gap-12 lg:gap-24 mb-24 md:mb-32 scroll-mt-32 px-4 sm:px-12 md:px-24 w-full relative overflow-hidden text-theme-blue`}>
      ...
      <div className="flex-1 flex flex-col items-center justify-start lg:sticky lg:top-32 h-fit md:px-4 sm:px-0">
        ...
        {/* Mobile Header (Shown only on mobile, moved out of the widget) */}
        <div className="md:hidden w-full mb-8 text-center px-4">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className={`font-mono text-xs sm:text-sm font-black tracking-widest ${theme.text} ${theme.bg} inline-block px-1.5 py-0.5 border-[2px] border-theme-blue shadow-[2px_2px_0px_0px_#1b27b5] mb-4`}>
              [ FEATURE ]
            </div>
            <h2 className="text-3xl font-black uppercase text-theme-blue tracking-tighter mb-4">
              {title}
            </h2>
            <p className="text-sm font-bold leading-tight text-theme-blue opacity-80 max-w-sm mx-auto">
              {description}
            </p>
          </motion.div>
        </div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className={`relative z-10 bg-theme-cream border-[4px] md:border-[6px] border-theme-blue p-2 md:p-4 shadow-[8px_8px_0px_0px_var(--theme-yellow)] md:shadow-[24px_24px_0px_0px_var(--theme-yellow)] max-w-[320px] md:max-w-[400px] w-full transform transition-transform duration-300 touch-pan-y`}
        >
          {/* Swipe indicator (Mobile only) */}
          <div className="md:hidden flex justify-center items-center gap-2 text-theme-blue opacity-40 font-mono text-[10px] sm:text-xs font-black uppercase pointer-events-none mb-3">
              <FiArrowLeft size={12} /> SWIPE <FiArrowRight size={12} />
          </div>
          ...
          <div className="relative flex items-center justify-center gap-2">
            ...
            <button
              ...
              className="md:hidden bg-white border-2 border-theme-blue p-2 shadow-[2px_2px_0px_0px_#1b27b5] active:translate-x-[1px] active:translate-y-[1px] active:shadow-none transition-all"
            ...
            >
              ...
              <div className={`${theme.bg} border-[2px] md:border-4 border-theme-blue p-1 md:p-2 relative overflow-hidden aspect-[9/19] bg-opacity-50`}>
                ...
                {/* Preview Tag & Page Name */}
                <div className="absolute bottom-2 left-2 right-2 md:bottom-4 md:left-4 flex items-center justify-between gap-2 z-20">
                  <div className="bg-theme-bg border-[2px] md:border-4 border-theme-blue px-1.5 md:px-3 py-0.5 md:py-1 font-mono text-[10px] sm:text-xs font-black uppercase text-theme-blue shadow-[2px_2px_0px_0px_#1b27b5] md:shadow-[4px_4px_0px_0px_#1b27b5] transform -rotate-2">
                      {activeIdx + 1}/{images.length}
                  </div>
                  <div className="md:hidden flex-1 bg-white border-[2px] border-theme-blue px-2 py-0.5 font-mono text-[9px] font-black uppercase text-theme-blue shadow-[2px_2px_0px_0px_#1b27b5] text-center line-clamp-1">
